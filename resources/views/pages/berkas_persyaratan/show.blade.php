                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="row g-3">
                                            <div class="col-6">
                                                ...
                                                <p class="mb-0 fw-semibold">#{{ $berkas->permohonan->nomor_permohonan }}</p>
                                            </div>
                                            ...
                                            <div class="col-6">
                                                ...
                                                <p class="mb-0">{{ $berkas->permohonan->jenisSurat->nama_jenis ?? '-' }}</p>
                                            </div>
                                            ...
                                            <div class="col-12">
                                                ...
                                                <p class="mb-0">{{ $berkas->permohonan->warga->no_telepon ?? '-' }}</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>

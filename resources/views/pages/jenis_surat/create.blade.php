                                ...
                                <div class="col-md-6">
                                    <div class="single-input position-relative">
                                        <input type="text" id="nama_jenis" name="nama_jenis"
                                            ...
                                            placeholder="Nama Jenis Surat" value="{{ old('nama_jenis') }}">
                                ...
                                <div class="col-md-12">
                                    <div class="single-input position-relative">
                                        <textarea id="syarat_json" name="syarat_json[]" class="form-input @error('syarat_json') is-invalid @enderror"
                                            placeholder="Syarat (pisahkan setiap syarat dengan koma)" rows="4">{{ old('syarat_json') ? implode(', ', old('syarat_json')) : '' }}</textarea>

        ...
        <div class="row justify-content-center">
            <div class="col-xxl-5 col-xl-5 col-lg-7 col-md-10">
                <div class="section-title text-center mb-50">
                    ...
                    <p>Perbarui data warga di bawah sesuai kebutuhan</p>
                </div>
            </div>
        </div>
                                ...
                                <div class="card border-0 shadow-sm">
                                    <div class="card-body">
                                        <h6 class="card-title d-flex align-items-center">
                                            <i class="lni lni-info-circle me-2"></i> Informasi Warga
                                        </h6>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4 mb-3">
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div>
                                                            <small class="text-muted d-block">Warga ID</small>
                                                        ...
                                                        <div>
                                                            ...
                                                            <span class="badge
                                                                ...
                                                                @if($warga->jenis_kelamin == 'Laki-laki')
                                                                    <i class="lni lni-male me-1"></i> Laki-laki
                                                                @else
                                                                    <i class="lni lni-female me-1"></i> Perempuan
                                                                @endif
                                                            </span>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="d-flex">
                                                    ...
                                                    <div>
                                                        <small>
                                                            ...
                                                            <ul class="mb-0 mt-2">
                                                                <li>Pastikan nomor KTP masih valid dan unik</li>
                                                                <li>Email harus unik jika diisi</li>
                                                                <li>Data yang ditandai dengan <span class="text-danger">*</span> wajib diisi</li>
                                                                <li>Sistem akan mencatat waktu perubahan data secara otomatis</li>
                                                                <li>Perubahan akan tercatat pada timestamp updated_at</li>
                                                            </ul>
                                                        </small>
                                                    </div>
                                                </div>
                            ...
                            <div class="col-md-12">
                                <div class="d-flex justify-content-end gap-3 mt-4 pt-3 border-top">
                                    ...
                                    <button type="submit" class="btn btn-success px-4" id="submitBtn">
                                        <i class="lni lni-telegram-original me-2"></i> Perbarui Data Warga
                                    </button>
                                </div>
                            </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function validateKTP() {
            if (ktpInput.value.length < 16 && ktpInput.value.length > 0) {
                ...
                submitBtn.innerHTML = '<i class="lni lni-telegram-original me-2"></i> Perbarui Data Warga';
                return true;
            }
        }
        ...
        // Warning jika email akan diganti
        ...
        if (emailInput.value !== originalEmail && originalEmail !== '') {
            ...
            warningDiv.innerHTML = `
                <i class="lni lni-warning me-2"></i>
                <strong>Perhatian:</strong> Email saat ini adalah <strong>${originalEmail}</strong>. Mengganti email mungkin mempengaruhi notifikasi sistem.
            `;
